<h2 align="center">
  <br>
  <img src="/asset/png/FrameLogo512.png?raw=true" alt="Decypher" width="150" />
  <br>
  <br>
  D E C Y P H E R
  <br>
...
Decypher is a native web3 interface that lets you sign data, securely manage accounts and transparently interact with dapps via web3 protocols like Ethereum and IPFS!
...
### Decypher's injected provider

Decypher also has a browser extension for injecting a Frame-connected [EIP-1193](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-1193.md) provider into web apps as `window.ethereum`. This can be used to inject a connection when an app does not provide the option to connect to Frame natively.

### Related

- [Qowalts](https://discord.gg/UH7NGqY) - Feel free to drop in and ask questions!
- [Dijets Browser Extension](https://github.com/floating/frame-extension) - Use Frame with any web dapp
...
<h2>
  <h5 align="center">
    <br>
    <a href="https://dijets.io">Website</a> ⁃
  </h5>
</h2>
