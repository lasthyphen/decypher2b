...
let bpiURL = "https://api.coingecko.com/api/v3/simple/price?ids=seedify-fund&vs_currencies=usd,eur";
class Balance extends React.Component {
  ...
  render () {
    ...
    const currentRate =() => {
      return this.state.data && this.state.data["seedify-fund"].usd
    }
