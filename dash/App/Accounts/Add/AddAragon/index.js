        ...
        <div className='addAccountItemWrap'>
          <div className='addAccountItemTop'>
            <div className='addAccountItemTopType'>
              ...
              <div className='addAccountItemTopTitle'>Dijets Council</div>
            </div>
            {/* <div className='addAccountItemClose' onMouseDown={() => this.props.close()}>{'Done'}</div> */}
            <div className='addAccountItemSummary'>Vote, review, arbitrate &amp; dispute proposals through Decypher</div>
          </div>
          <div className='addAccountItemOption'>
            <div className='addAccountItemOptionIntro' onMouseDown={() => this.adding()}>
              <div className='addAccountItemDeviceTitle'>Add Member Account</div>
            </div>
            <div className='addAccountItemOptionSetup' style={{ transform: `translateX(-${100 * this.state.index}%)` }}>
              <div className='addAccountItemOptionSetupFrames'>
                ...
                <div className='addAccountItemOptionSetupFrame'>
                  <div className='addAccountItemOptionTitle'>enter proposal ID</div>
                  <div className='addAccountItemOptionInputPhrase'>
          ...
          <div
            className='addAccountItemFooter' onClick={() => {
              ...
              if (net === '43112') return open('https://mainnet.aragon.org')
              if (net === '4') return open('https://rinkeby.aragon.org')
              return open('https://gov.dijets.io')
            }}
          >{''}
          </div>
        </div>
