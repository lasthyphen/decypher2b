          ...
          <div className='notifyBox'>
            ...
            <div className='notifyBody'>
              <div className='notifyBodyBlock notifyBodyBlockBig'>
                We are excited to welcome you to the next iteration of Decypher!
              </div>
              <div className='notifyBodyBlock'>
                Be advised, this version of Decypher is currently in "beta" and will update on a beta track
              </div>
              <div className='notifyBodyBlock'>
              ...
              <div className='notifyBodyBlock'>
                ...
                <span 
                  ...
                  onMouseDown={() => { link.send('tray:openExternal', 'https://dijets.io/privacy-policy') }}
                >
                  our license
                </span>
                <span>and use Decypher at your own risk</span>
              </div>
              <div className='notifyBodyBlock notifyBodyBlockBig'>
                ...
                <div 
                  ...
                  onMouseDown={() => { link.send('tray:openExternal', 'mailto@support@dijets.io') }}
                >
                  Dijets Support
                </div>
              </div>
        ...
        <div className='notifyBox'>
          ...
          <div className='notifyBody'>
            {feeUSD !== '0.00' ? (
              ...
              <div className='notifyBodyLine'>The max fee for this transaction is: 0.001 DJTX</div>
            )}
    ...
    return (
      <div className='notifyBoxWrap' onMouseDown={e => e.stopPropagation()} style={this.store('view.notify') === 'hotAccountWarning' ? { transform: 'translateX(calc(-100% - 100px))' } : {}}>
        <div className='notifyBox'>
          ...
          <div className='notifyBody'>
            <div className='notifyBodyLine'>Decypher hot signers are in alpha! Do not use them with high value accounts and verify your backups are valid. Only proceed if you understand and accept these risks.</div>
          </div>
          <div className='notifyInput'>
            <div className='notifyInputOption notifyInputSingleButton' onMouseDown={() => { link.send('tray:action', 'backDash') }}>
              <div className='notifyInputOptionText'>OK</div>
