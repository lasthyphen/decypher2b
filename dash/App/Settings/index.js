...
class Settings extends React.Component {
  ...
  discord () {
    return (
      <div className='discordInvite' onClick={() => link.send('tray:openExternal', 'https://discord.gg/') }>
        <div>Need help?</div>
        ...
        <div className='localSettingsWrap'>
          ...
          <div className='signerPermission localSetting' style={{ zIndex: 214 }}>
            ...
            <div className='signerPermissionDetails'>
              <span>
                Summon Decypher by pressing <span className='keyCommand'>{this.store('platform') === 'darwin' ? 'Option' : 'Alt'}<span style={{ padding: '0px 3px' }}>+</span>/</span>
              </span>
            </div>
          </div>
          <div className='signerPermission localSetting' style={{ zIndex: 213 }}>
            ...
            <div className='signerPermissionDetails'>
              <span>
                Hide Decypher on loss of focus
              </span>
            </div>
          </div>
          <div className='signerPermission localSetting' style={{ zIndex: 212 }}>
            ...
            <div className='signerPermissionDetails'>
              Run Decypher when your computer starts
            </div>
          </div>
          <div className='signerPermission localSetting' style={{ zIndex: 211 }}>
            ...
            <div className='signerPermissionDetails'>
              {'Mouse to display\'s right edge to summon Decypher'}
            </div>
          </div>
          ...
          <div className='signerPermission localSetting' style={{ zIndex: 209 }}>
            ...
            <div className='signerPermissionDetails'>
              <span>
                Help improve Decypher by anonymously reporting errors
              </span>
            </div>
          </div>
          ...
          <div className='signerPermission localSetting' style={{ zIndex: 207 }}>
            <div className='signerPermissionControls'>
              <div className='signerPermissionSetting'>Show Dijets Account Name</div>
              <div
          ...
          <div className='signerPermission localSetting' style={{ zIndex: 199 }}>
            <div className='signerPermissionControls'>
              <div className='signerPermissionSetting'>Lock Hot Wallets on</div>
              <Dropdown
            ...
            <div className='signerPermissionDetails'>
              When should Decypher relock your hot wallets?
            </div>
          </div>
        </div>
      </div>
