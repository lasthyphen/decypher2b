...
const getNormalTransactions = (address) => {
  fetch(`http://20.9.33.115:4000/api?module=account&action=txlist&address=${address}&startblock=0&endblock=99999999&sort=asc`)
}

const getInternalTransactions = (address) => {
  fetch(`http://20.9.33.115:4000/api?module=account&action=txlistinternal&address=${address}&startblock=0&endblock=99999999&sort=asc`)
}


const getERC20TransferEvents = (address) => {
  fetch(`http://20.9.33.115:4000/api?module=account&action=tokentx&address=${address}&startblock=0&endblock=999999999&sort=asc`)
}

const getERC721TransferEvents = (address) => {
  fetch(`http://20.9.33.115:4000/api?module=account&action=tokennfttx&address=${address}&startblock=0&endblock=999999999&sort=asc`)
}